...
if(isset($_POST['add_user'])){
    ...
    elseif ($pass != $c_pass){
        ...
        if($row >= 1) {
            ...
            if($query2) {
                $msg=['User has been added','alert-success'];
            $_SESSION['msg']=$msg;
...
<div class="container">
    <div class="row">
        <div class="col-md-5 m-auto bg-success p-4">
            <?php  
            if(!empty($error)) {
            ...
            <div class="mb-3">
                ...
                value="<?= (!empty($error))? $username : ''; ?>" required>
            </div>
            <div class="mb-3">
                <input type="email" name="email" placeholder="Email" class="form-control" 
                value="<?= (!empty($error))? $email : ''; ?>"  required>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                <input type="submit" name="add_user" class="btn btn-dark" value="Create">
