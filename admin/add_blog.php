        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="" method="POST" enctype="multipart/form-data">
                    <div class="mb-3">
                        <input type="text" name="blog_title" placeholder="Post Title" class="form-control" required>
                    </div>
                    <div class="mb-3">
...
if(in_array($image_ext,$allow_type)){
    if($size<=2000000){
        ...
        if($query2){
            $msg=['Post has been published','alert-success'];
            $_SESSION['msg']=$msg;
        header('location:add_blog.php');
            
        }else {
            $msg=['Failed to add','alert-danger'];
            $_SESSION['msg']=$msg;
        header('location:add_blog.php');
        }
    }else {
